...
public class MyExternalCallControlServer {

    private static Logger LOG = Logger.getLogger(MyExternalCallControlServer.class.getName());

    private final String url;
    private HttpServer httpServer;

    public MyExternalCallControlServer(String url) {
        this.url = url;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        LogManager.getLogManager().readConfiguration(
                MyExternalCallControlServer.class.getResourceAsStream("/logging.properties"));
        ...
        MyExternalCallControlServer myServer = new MyExternalCallControlServer(args[0]);
        myServer.run();
    }
    ...
    private void run() throws Exception {
        ...
        ResourceConfig rc = new ResourceConfig()
                ...
                .register(MyObjectMapperProvider.class) // Allows to configure the ObjectMapper
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            @Override
            public void run() {
                synchronized (MyExternalCallControlServer.class) {
                    MyExternalCallControlServer.this.stop();
